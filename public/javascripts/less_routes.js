...
function user_blogs_path(profile_id, verb){ return '/profiles/' + profile_id + '/blogs';}
function user_blogs_ajax(profile_id, verb, params, options){ return less_ajax('/profiles/' + profile_id + '/blogs', verb, params, options);}
function user_blogs_ajaxx(profile_id, verb, params, options){ return less_ajaxx('/profiles/' + profile_id + '/blogs', verb, params, options);}
function formatted_user_blogs_path(profile_id, format, verb){ return '/profiles/' + profile_id + '/blogs.' + format + '';}
function formatted_user_blogs_ajax(profile_id, format, verb, params, options){ return less_ajax('/profiles/' + profile_id + '/blogs.' + format + '', verb, params, options);}
function formatted_user_blogs_ajaxx(profile_id, format, verb, params, options){ return less_ajaxx('/profiles/' + profile_id + '/blogs.' + format + '', verb, params, options);}
function new_user_blog_path(profile_id, verb){ return '/profiles/' + profile_id + '/blogs/new';}
function new_user_blog_ajax(profile_id, verb, params, options){ return less_ajax('/profiles/' + profile_id + '/blogs/new', verb, params, options);}
function new_user_blog_ajaxx(profile_id, verb, params, options){ return less_ajaxx('/profiles/' + profile_id + '/blogs/new', verb, params, options);}
function formatted_new_user_blog_path(profile_id, format, verb){ return '/profiles/' + profile_id + '/blogs/new.' + format + '';}
function formatted_new_user_blog_ajax(profile_id, format, verb, params, options){ return less_ajax('/profiles/' + profile_id + '/blogs/new.' + format + '', verb, params, options);}
function formatted_new_user_blog_ajaxx(profile_id, format, verb, params, options){ return less_ajaxx('/profiles/' + profile_id + '/blogs/new.' + format + '', verb, params, options);}
function edit_user_blog_path(profile_id, id, verb){ return '/profiles/' + profile_id + '/blogs/' + id + '/edit';}
function edit_user_blog_ajax(profile_id, id, verb, params, options){ return less_ajax('/profiles/' + profile_id + '/blogs/' + id + '/edit', verb, params, options);}
function edit_user_blog_ajaxx(profile_id, id, verb, params, options){ return less_ajaxx('/profiles/' + profile_id + '/blogs/' + id + '/edit', verb, params, options);}
function formatted_edit_user_blog_path(profile_id, id, format, verb){ return '/profiles/' + profile_id + '/blogs/' + id + '/edit.' + format + '';}
function formatted_edit_user_blog_ajax(profile_id, id, format, verb, params, options){ return less_ajax('/profiles/' + profile_id + '/blogs/' + id + '/edit.' + format + '', verb, params, options);}
function formatted_edit_user_blog_ajaxx(profile_id, id, format, verb, params, options){ return less_ajaxx('/profiles/' + profile_id + '/blogs/' + id + '/edit.' + format + '', verb, params, options);}
function user_blog_path(profile_id, id, verb){ return '/profiles/' + profile_id + '/blogs/' + id + '';}
function user_blog_ajax(profile_id, id, verb, params, options){ return less_ajax('/profiles/' + profile_id + '/blogs/' + id + '', verb, params, options);}
function user_blog_ajaxx(profile_id, id, verb, params, options){ return less_ajaxx('/profiles/' + profile_id + '/blogs/' + id + '', verb, params, options);}
function formatted_user_blog_path(profile_id, id, format, verb){ return '/profiles/' + profile_id + '/blogs/' + id + '.' + format + '';}
function formatted_user_blog_ajax(profile_id, id, format, verb, params, options){ return less_ajax('/profiles/' + profile_id + '/blogs/' + id + '.' + format + '', verb, params, options);}
function formatted_user_blog_ajaxx(profile_id, id, format, verb, params, options){ return less_ajaxx('/profiles/' + profile_id + '/blogs/' + id + '.' + format + '', verb, params, options);}
